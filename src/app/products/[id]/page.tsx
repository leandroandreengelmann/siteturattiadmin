            ...
            <div className="p-4 md:p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a 
                    href={`https://wa.me/5511999999999?text=Olá, tenho interesse no produto: ${product.name} (ID: ${product.id})`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg text-center transition duration-300 flex items-center justify-center flex-1 shadow-sm"
                  >
